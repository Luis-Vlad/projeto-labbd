...
<head>
    ...
    <title>Projeto Lab Banco de Dados - Relatório Pedido</title>
...
<body>
    <h1 class="text-center bg-primary text-white mb-5">Relatório - Pedidos</h1>
    <div class="container">

        <form class="row" method="POST" action="/projeto-labbd/controllers/pedido-relatorio-controller.php">
